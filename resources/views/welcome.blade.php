                            ...
                            <div class="limit-box">
                                <nav class="main-menu">
                                    <ul class="menu-area-main">
                                        ...
                                        <li class="last"><a href="#"><img src="images/search_icon.png"
                                                    alt="icon" /></a></li>
                                    </ul>
                                </nav>
                            </div>
                            ...
                            <div class="carousel-item active">
                                <div class="titlepage">
                                    <div class="john">
                                        ...
                                        <div class="john_text">JOHN DUE<span style="color: #fffcf4;">(ceo)</span>
                                        </div>
                ...
                <div class="contact_us_3 layout_padding">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <p class="long_text">It is a long established fact that a reader will be distracted a
                            </p>
                        </div>
                        <div class="col-md-8">
